...
🚀 myEasyCompta Addons - Now Available!

Take your accounting experience to the next level with powerful addons for myEasyCompta. Explore and download the latest addons at [https://myeasycompta.com/addons](https://myeasycompta.com/addons).

🗓️ Planning: Manage and schedule your tasks, appointments, and deadlines effortlessly.
🎫 Ticket Support: Offer seamless client support with an integrated ticketing system.
🧾 Automatic Invoice Creation: Save time by automatically generating invoices for WooCommerce orders.
📊 Data Export: Easily export your data (clients, invoices, quotes, etc.) for backups and reports.
📈 Clients Frontend Dashboard: Empower your clients with a dedicated dashboard to view their quotes, invoices, and other relevant details.

Visit [myEasyCompta.com](https://myeasycompta.com/addons) to discover more features and enhance your workflow with myEasyCompta!
...
= 1.3.1 =
* Fix: Corrected quantity display issue in the PDF when the quantity is a decimal number.

= 1.3.0 =
* Fix: License activation issue resolved.
* Add: Search filters for clients, quotes, invoices, payments, and expenses.
* Add: Ability to add a new client directly from the "Add New Quote or Invoice" page.

= 1.2.4 =
* Fix: Database migration issue corrected.
* Fix: Updated the file upload system for expenses to enhance security.
...
= 1.2.2 =
* Fix: Issue with installed version verification and database migration resolved.
...
* Fix: PDF display issue when VAT is enabled resolved.

= 1.1.0 =
* Add: Database migration function for new versions.
* Add: Added VAT field for clients.
* Add: New options in invoice and quote settings (payment conditions, IBAN, etc.).
* Fix: PDF display issue resolved when a discount is applied.
