    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            ...
            <div class="card-body flex flex-col flex-grow">
                ...
                <div class="flex card-actions justify-end mt-auto btn-rounded">
                    <a class="btn btn-primary hover:text-white rounded-full"
                        href="https://myeasycompta.com/addons-all/myeasycompta-e-mail/"
        ...
        <div class="card p-6 bg-base-100 shadow-xl flex flex-col">
            <div class="card-body flex flex-col flex-grow">
                ...
                <div class="flex card-actions justify-end mt-auto btn-rounded">
                    <a class="btn btn-primary hover:text-white rounded-full"
                        href="https://myeasycompta.com/addons-all/myeasycompta-export/"
                        target="_blank"><?php esc_html_e('Read more', 'my-easy-compta');?></a>
                </div>
            </div>
        </div>
        <div class="card p-6 bg-base-100 shadow-xl flex flex-col">
            <div class="card-body flex flex-col flex-grow">
                ...
                <div class="flex card-actions justify-end mt-auto btn-rounded">
                    <a class="btn btn-primary hover:text-white rounded-full"
                        href="https://myeasycompta.com/addons-all/myeasycompta-planning/"
                        target="_blank"><?php esc_html_e('Read more', 'my-easy-compta');?></a>
                </div>
            </div>
        </div>
        <div class="card p-6 bg-base-100 shadow-xl flex flex-col">
            <div class="card-body flex flex-col flex-grow">
                ...
                <div class="flex card-actions justify-end mt-auto btn-rounded">
                    <a class="btn btn-primary hover:text-white rounded-full"
                        href="https://myeasycompta.com/addons-all/myeasycompta-stats/"
                        target="_blank"><?php esc_html_e('Read more', 'my-easy-compta');?></a>
                </div>
            </div>
        </div>
        <div class="card p-6 bg-base-100 shadow-xl flex flex-col">
            <div class="card-body flex flex-col flex-grow">
                ...
                <div class="flex card-actions justify-end mt-auto btn-rounded">
                    <a class="btn btn-primary hover:text-white rounded-full"
                        href="https://myeasycompta.com/addons-all/myeasycompta-compte-client/"
                        target="_blank"><?php esc_html_e('Read more', 'my-easy-compta');?></a>
                </div>
            </div>
        </div>
        <div class="card p-6 bg-base-100 shadow-xl flex flex-col">
            <div class="card-body flex flex-col flex-grow">
                ...
                <div class="flex card-actions justify-end mt-auto btn-rounded">
                    <a class="btn btn-primary hover:text-white rounded-full"
                        href="https://myeasycompta.com/addons-all/myeasycompta-siret/"
                        target="_blank"><?php esc_html_e('Read more', 'my-easy-compta');?></a>
                </div>
            </div>
        </div>
        <div class="card p-6 bg-base-100 shadow-xl flex flex-col">
            <div class="card-body flex flex-col flex-grow">
                ...
                <div class="flex card-actions justify-end mt-auto btn-rounded">
                    <a class="btn btn-primary hover:text-white rounded-full"
                        href="https://myeasycompta.com/addons-all/myeasycompta-woo/"
                        target="_blank"><?php esc_html_e('Read more', 'my-easy-compta');?></a>
                </div>
            </div>
        </div>
        <div class="card p-6 bg-base-100 shadow-xl flex flex-col">
            <div class="card-body flex flex-col flex-grow">
                ...
                <div class="flex card-actions justify-end mt-auto btn-rounded">
                    <a class="btn btn-primary hover:text-white rounded-full"
                        href="https://myeasycompta.com/addons-all/myeasycompta-backup/"
                        target="_blank"><?php esc_html_e('Read more', 'my-easy-compta');?></a>
                </div>
            </div>
        </div>
        <div class="card p-6 bg-base-100 shadow-xl flex flex-col">
            <div class="card-body flex flex-col flex-grow">
                ...
                <div class="flex card-actions justify-end mt-auto btn-rounded">
                    <a class="btn btn-primary hover:text-white rounded-full"
                        href="https://myeasycompta.com/addons-all/myeasycompta-signature/"
                        target="_blank"><?php esc_html_e('Read more', 'my-easy-compta');?></a>
                </div>
            </div>
        </div>
        <div class="card p-6 bg-base-100 shadow-xl flex flex-col">
            <div class="card-body flex flex-col flex-grow">
                <h2 class="card-title mb-2"><?php esc_html_e('myEasyCompta Payment', 'my-easy-compta');?></h2>
                <p class="mb-2 flex-grow">
                    <?php esc_html_e('myEasyCompta Payment allows myEasyCompta users to offer their clients the ability to pay invoices directly through secure and integrated payment options.', 'my-easy-compta');?>
                </p>
                <div class="flex card-actions justify-end mt-auto btn-rounded">
                    <a class="btn btn-primary hover:text-white rounded-full"
                        href="https://myeasycompta.com/addons-all/myeasycompta-payment/"
                        target="_blank"><?php esc_html_e('Read more', 'my-easy-compta');?></a>
                </div>
            </div>
        </div>
