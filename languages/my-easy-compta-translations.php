...
$translations = array(
    ...
    'active_disbursements' => __('Active Disbursements', 'my-easy-compta'),
    ...
    'quote_draft_cannot_send' => __('Quote in draft status cannot be sent.', 'my-easy-compta'),
    'active_sign_addon' => __('You need to activate the Signature addon to benefit from this feature.', 'my-easy-compta'),
    'stripe_settings' => __('Stripe settings', 'my-easy-compta'),
    ...
    'disbursements' => __('Disbursements', 'my-easy-compta'),
    'title' => __('Title', 'my-easy-compta'),
    'description' => __('Description', 'my-easy-compta'),
    'price' => __('Price', 'my-easy-compta'),
    'add_disbursements' => __('Add disbursement', 'my-easy-compta'),
    'total_disbursements' => __('Total disbursements', 'my-easy-compta'),
);
